    ...
    comments: [
      {
        id: 101,
        author: "data_guru",
        body: "Definitely use NumPy. It's built for this.",
        votes: 15,
      ...
      },
      {
        id: 102,
        author: "speed_demon",
        body: "List comprehensions are faster than for loops, but NumPy wins for math operations.",
        votes: 8,
    ...
    comments: [
      {
        id: 201,
        author: "flex_master",
        body: "display: grid; place-items: center; -> Done.",
        votes: 50,
...
const VoteControl = ({ votes, size = "md" }) => {
  ...
  return (
    <div
      className={`flex flex-col items-center gap-1 ${size === "sm" ? "mr-4" : "mr-6"}`}
    >
      <button
        onClick={(e) => {
          e.stopPropagation();
        ...
        className={`p-1 rounded hover:bg-zinc-800 transition-colors ${currentVote === 1 ? "text-emerald-500" : "text-zinc-500"}`}
      >
        <ArrowBigUp
          size={size === "sm" ? 24 : 32}
      ...
      <span
        className={`font-bold ${size === "sm" ? "text-sm" : "text-lg"} ${currentVote === 1 ? "text-emerald-500" : currentVote === -1 ? "text-rose-500" : "text-zinc-300"}`}
      >
        {displayVotes}
      </span>
      ...
      <button
        ...
        className={`p-1 rounded hover:bg-zinc-800 transition-colors ${currentVote === -1 ? "text-rose-500" : "text-zinc-500"}`}
      >
        <ArrowBigDown
          size={size === "sm" ? 24 : 32}
          fill={currentVote === -1 ? "currentColor" : "none"}
...
const PostCard = ({ post, onClick }) => (
  ...
  >
    ...
    <div className="flex-1 min-w-0">
      ...
      <p className="text-zinc-400 text-sm line-clamp-2 mb-3">{post.body}</p>
...
const Comment = ({ comment }) => (
  <div className="flex gap-3 p-4 border-b border-zinc-800/50 hover:bg-zinc-900/30 transition-colors">
    <div className="flex flex-col items-center gap-1 pt-1">
      <button className="text-zinc-500 hover:text-emerald-500">
        <ArrowBigUp size={20} />
      </button>
      <button className="text-zinc-500 hover:text-rose-500">
...
export default function CommunityPage() {
  ...
  return (
    <div className="flex h-screen w-full bg-black text-zinc-300 font-sans selection:bg-blue-900 selection:text-white overflow-hidden">
      {/* SIDEBAR NAVIGATION */}
        ...
        <div className="h-16 flex items-center px-6 border-b border-zinc-800">
          ...
          >
            <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center">
              <span className="text-white font-mono text-lg font-bold leading-none pt-1">
                &gt;_
              </span>
            </div>
            <span>.repl</span>
        ...
        <div className="flex-1 py-6 px-3 space-y-6 overflow-y-auto">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 px-3">
              {["javascript", "python", "rust", "react", "css", "ai"].map(
                (t) => (
                  <span
                    key={t}
        ...
        <div className="h-16 border-b border-zinc-800 bg-[#09090b]/80 backdrop-blur-md sticky top-0 z-10 flex items-center justify-between px-6">
            ...
            {view === "post" || view === "create" ? (
              ...
              <div className="relative w-full max-w-md">
                ...
                <input
                  ...
                  className="w-full bg-zinc-900 border border-zinc-700 text-zinc-200 text-sm rounded-full pl-10 pr-4 py-2 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all placeholder:text-zinc-600"
                />
              </div>
            )}
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold rounded-full transition-all shadow-lg shadow-blue-500/20 active:scale-95"
            >
              <Plus size={16} />
              Ask Question
            </button>
                ...
                <div className="bg-[#09090b] border border-zinc-800 rounded-lg p-6 space-y-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-black border border-zinc-800 rounded-md p-3 text-zinc-200 focus:outline-none focus:border-blue-500 transition-colors"
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-black border border-zinc-800 rounded-md p-3 text-zinc-200 focus:outline-none focus:border-blue-500 min-h-[200px] font-mono text-sm"
              ...
              <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                <div className="flex items-center justify-between mb-2 px-2">
                  ...
                  <div className="flex bg-zinc-900 rounded-lg p-1 border border-zinc-800">
                    <button className="px-3 py-1 text-xs font-medium bg-zinc-700 text-white rounded shadow-sm">
                      Interesting
                    </button>
                    <button className="px-3 py-1 text-xs font-medium text-zinc-500 hover:text-zinc-300">
                      Hot
                    </button>
                    <button className="px-3 py-1 text-xs font-medium text-zinc-500 hover:text-zinc-300">
                      Week
            ...
            {view === "post" && activePost && (
              <div className="animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                <div className="flex gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <h1 className="text-2xl font-bold text-zinc-100 mb-4 leading-snug">
                      {activePost.title}
                    </h1>
                ...
                <div className="ml-12 md:ml-16">
                  ...
                  <div className="bg-[#09090b] border border-zinc-800 rounded-lg p-4">
                    ...
                    <textarea
                      ...
                      className="w-full bg-black border border-zinc-800 rounded-md p-3 text-sm text-zinc-200 focus:outline-none focus:border-blue-500 min-h-[120px] mb-3 placeholder:text-zinc-700"
